...
def generate_launch_description():
    ...
    world_arg = DeclareLaunchArgument(name="world", default_value=os.path.join(
        bumperbot_description, "worlds", "small_house.world"
    ))

    # world_path = PathJoinSubstitution([bumperbot_description, "worlds", PythonExpression(expression=["'",LaunchConfiguration("world"),"'","+'.world'"])])
    world_path = os.path.join(bumperbot_description, "worlds", "small_house.world")
