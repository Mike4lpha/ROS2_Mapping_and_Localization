...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(get_package_share_directory('bumperbot_mapping'), 'maps', 'small_house', 'map.yaml'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(get_package_share_directory('bumperbot_localization'), 'rviz', 'nav2_default_view.rviz'),
    ...
    robot_localization_node = Node(
       ...
       output='screen',
       parameters=[os.path.join(get_package_share_directory('bumperbot_localization'), 'config/ekf.yaml'), {'use_sim_time': use_sim_time}]
)
